...
const testimonials = [
  {
    quote:
      "First Haven made our home buying process incredibly smooth. Their communication was top-notch, and we always felt like a priority.",
    author: "Sarah & Tom L.",
    role: "Home Buyers",
  },
  {
    quote:
      "As a real estate agent, I rely on escrow partners who are responsive and detail-oriented. First Haven Escrow consistently delivers.",
    author: "Michael B.",
