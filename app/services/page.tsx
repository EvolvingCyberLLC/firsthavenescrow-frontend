...
export const metadata: Metadata = {
  title: "Escrow Services | First Haven Escrow",
  description:
        ...
        <section className="bg-[var(--light-gray)] py-16 lg:py-20">
          <div className="container-custom text-center">
            ...
            <p className="text-lg text-[var(--text-muted)] max-w-3xl mx-auto mb-8">
              First Haven Escrow provides escrow services for a wide range of
              real estate and specialty transactions. Whether you are buying,
