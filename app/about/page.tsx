...
export const metadata: Metadata = {
  title: "About Us | First Haven Escrow",
  description:
    "Learn about First Haven Escrow, our approach to escrow, and how we support residential and commercial transactions across Southern California.",
};
        ...
        <section className="bg-[var(--light-gray)] py-16 lg:py-20">
          <div className="container-custom">
            <div className="max-w-3xl">
              <h1 className="heading-xl mb-6">About First Haven Escrow</h1>
              <p className="text-lg text-[var(--text-muted)]">
                First Haven Escrow is an independent escrow company serving
                clients across Southern California. We provide escrow services
                for residential, commercial, and specialty transactions, acting
                as a neutral third party to help ensure each transaction is
                completed according to written instructions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-[var(--light-gray)]">
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-[var(--text-muted)]">
                First Haven Escrow is licensed by the California Department of
