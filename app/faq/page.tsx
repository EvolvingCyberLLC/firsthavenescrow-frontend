...
export const metadata: Metadata = {
  title: "Frequently Asked Questions | First Haven Escrow",
  description:
    "Get answers to common questions about the escrow process, fees, timelines, and what to expect when working with First Haven Escrow.",
};
